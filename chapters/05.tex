...
\lsptoprule
& \multicolumn{4}{c}{Syllable structure complexity}\\\cmidrule(lr){2-5}
& Simple & Moderately Complex & Complex & Highly Complex & Total\\
...
& \multicolumn{5}{c}{{Languages with prevalent Highly Complex patterns}}\\\midrule
 Cocopa & \ding{51} & \ding{51} & \cellcolor{lsLightGray} & \ding{51} & \ding{51}\\
 Georgian & \ding{51} & \ding{51} & { \ding{51}} & \cellcolor{lsLightGray} & \cellcolor{lsLightGray}  \textit{(nr)}\\
 Itelmen & \ding{51} & \ding{51} & { \ding{51}} & \cellcolor{lsLightGray} & \cellcolor{lsLightGray} \\
 Polish & \ding{51} & \ding{51} & \ding{51} & \ding{51} & \ding{51}\\
 Tashlhiyt & \cellcolor{lsLightGray} & \ding{51} & {} & \cellcolor{lsLightGray} & \cellcolor{lsLightGray} \\
 Thompson & \ding{51} & \ding{51} & {} & \ding{51} & \ding{51}\\
 Tohono O’odham & \ding{51} & \ding{51} & {} & \ding{51} & \ding{51}\\
 Yakima Sahaptin & \ding{51} & \ding{51} & \ding{51} & \ding{51} & \cellcolor{lsLightGray} \\\midrule
& \multicolumn{5}{c}{{Languages with intermediate Highly Complex patterns}}\\\midrule
 Albanian & \ding{51} & \ding{51} & \ding{51} & \ding{51} & \ding{51}\\
 Camsá & \ding{51} & \ding{51} & \ding{51} & \ding{51} & \ding{51}\\
 Kabardian & \ding{51} & \ding{51} & \ding{51} & \ding{51} & \ding{51}\\
 Lezgian & \ding{51} & \ding{51} & \ding{51} & \ding{51} & \ding{51}\\
 Mohawk & \ding{51} & \cellcolor{lsLightGray} & \ding{51} & \cellcolor{lsLightGray} & \cellcolor{lsLightGray} \\
 Nuu-chah-nulth & \ding{51} & \ding{51} & \ding{51} & \ding{51} & \ding{51}\\
 Passamaquoddy-Maliseet & \ding{51} & \cellcolor{lsLightGray} & \ding{51} & \ding{51} & \ding{51}\\
 Yine & \ding{51} & \ding{51} & \ding{51} & \ding{51} & \cellcolor{lsLightGray} \\
 Qawasqar & \cellcolor{lsLightGray}  (unclear) & \ding{51} & \cellcolor{lsLightGray} & \cellcolor{lsLightGray} & \cellcolor{lsLightGray} \\
 Semai & \ding{51} & \ding{51} & \ding{51} & \cellcolor{lsLightGray} & \cellcolor{lsLightGray} \textit{(nr)}\\
 Tehuelche & \ding{51} & \ding{51} & \ding{51} & \ding{51} & \cellcolor{lsLightGray} \textit{(nr)}\\\midrule
& \multicolumn{5}{c}{{Languages with minor Highly Complex patterns}}\\\midrule
 Alamblak & \ding{51} & \ding{51} & \ding{51} & \ding{51} & \textit{(nr)}\\
 Bench & \cellcolor{lsLightGray} & \cellcolor{lsLightGray} & \cellcolor{lsLightGray} & \cellcolor{lsLightGray} & \cellcolor{lsLightGray} \\
 Doyayo & \cellcolor{lsLightGray} & \cellcolor{lsLightGray} & \cellcolor{lsLightGray} & \cellcolor{lsLightGray} & \cellcolor{lsLightGray} \\
 Kunjen & \ding{51} & \ding{51} & \cellcolor{lsLightGray} & \cellcolor{lsLightGray} & \ding{51}\\
 Menya & \ding{51} & \cellcolor{lsLightGray} & \ding{51} & \cellcolor{lsLightGray} & \cellcolor{lsLightGray} \textit{(nr)}\\
 Wutung & \ding{51} & \cellcolor{lsLightGray} & \cellcolor{lsLightGray} & \cellcolor{lsLightGray} & \ding{51}\\
\lspbottomrule
\end{tabularx}
