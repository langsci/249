...
\multicolumn{6}{c}{{Languages with prevalent Highly Complex patterns}}\\\midrule
 ...
 Tashlhiyt & \cellcolor{lsLightGray} & \ding{51} & \cellcolor{lsLightGray} & \cellcolor{lsLightGray} & \cellcolor{lsLightGray} \\
 Thompson & \ding{51} & \ding{51} & \cellcolor{lsLightGray} & \ding{51} & \ding{51}\\
 Tohono O’odham & \ding{51} & \ding{51} & \cellcolor{lsLightGray} & \ding{51} & \ding{51}\\
 ...
 Nuu-chah-n. & \ding{51} & \ding{51} & \ding{51} & \ding{51} & \ding{51}\\
