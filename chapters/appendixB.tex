...
\item[Notes:] /ɣ/ doesn’t occur in W. Arrernte, but is retained in Alyawarra \citep[12]{Yallop1977}.
\end{appendixdesc}
\subsubsection*{Syllable structure}
\begin{appendixdesc}
...
\end{appendixdesc}
\subsection*{[ayz]}\addxcontentsline{tocappendix}{section}{[ayz]}   {\textsc{Maybrat}}  Maybrat-Karon (Indonesia)
...
\item[Notes:] /ʔ t͡s t͡ʃ f v z ʒ/ occur only in loans. Vowel inventory is taken from \citet{BerksonEtAl2016} acoustic study. /ɯ/ is the ‘canonical’ phoneme but quality is closer to [ʌ]. /e ɔ/ occur only in loanwords from Russian.
\end{appendixdesc}
\subsubsection*{Syllable structure}
\begin{appendixdesc}
...
\item[Notes:] Occasionally CCV syllables occur in loanwords. The only cases of closed syllables are in a few French loans in well-educated speech \citep[113]{Morse1976}.
\end{appendixdesc}
\subsubsection*{Suprasegmentals}
\begin{appendixdesc}
\item[Tone:] Yes
...
\item[Onset restrictions:] All consonants may occur as a simple onset, though /ŋ/ and /j/ do not occur word-initially. Biconsonantal onsets occur with /p b p\textsuperscript{h} t d t\textsuperscript{h} ɡ/ as C\textsubscript{1} and /ɾ j/ as C\textsubscript{2}. Anderson also gives example of /ɡɣ/ onset in Standard Burushaski.
...
\subsection*{[cap]}\addxcontentsline{tocappendix}{section}{[cap]}   {\textsc{Chipaya}}  Uru-Chipaya (Bolivia)
...
\item[Notes:] Vowel devoicing is one of the most salient phonetic properties of the language (Cerrón-\citealt{Palomino2006}: 62). Historical elision of pre-stress vowels is responsible for some of the onset sequences in Chipaya (Cerrón-\citealt{Palomino2006}: 65).
\end{appendixdesc}
\subsubsection*{Consonant allophony processes}
\begin{appendixdesc}
...
\item[Notes:] /e/ occurs only in loanwords from Spanish, English.
\end{appendixdesc}
\subsubsection*{Syllable structure}
\begin{appendixdesc}
...
\item[Notes:] Most Formosan languages have canonical (C)V(C) structure; related language Paiwan also has (C)V(C). In Budai Rukai, a small number of sonorant codas such as nasals and laterals were attested in fast speech, but reconfirmation by author revealed (C)V forms for these \citep[213]{Chen2006}.
\end{appendixdesc}
\subsubsection*{Suprasegmentals}
\begin{appendixdesc}
\item[Tone:] No
...
\item[dyo-R1:] High-mid central vowel /ɘ/ is lowered to the quality of English [ə] when unstressed \citep[6]{Sapir1965}.
\end{appendixdesc}
\subsubsection*{Consonant allophony processes}
\begin{appendixdesc}
...
\item[Text:] “A Fur text” \citep[125-127]{Jakobi1990}
...
\item[Notes:] /r ɲ ʎ/ occur in Russian, Koryak loans. Some sources have /ʔ/ as a suprasegmental phenomenon, but \citet{GeorgVolodin1999} consider it a segment. 
\end{appendixdesc}
\subsubsection*{Syllable structure}
\begin{appendixdesc}
...
\subsection*{[kat]}\addxcontentsline{tocappendix}{section}{[kat]}   {\textsc{Georgian}}    Kartvelian, \textit{Georgian-Zan} (Georgia)
...
\subsection*{[kbd]}\addxcontentsline{tocappendix}{section}{[kbd]}   {\textsc{Kabardian}}  Abkhaz-Adyge, \textit{Circassian} (Russia, Turkey)
...
\item[Notes:] /ħ/ is marginal; exists in the speech of older generations, mostly in Arabic loans \citep[10]{Matasovic2010}. Colarusso has /c ɟ/ or /t̠ d̠/ for /t͡ʃ d͡ʒ/, and doesn’t have /ɣ/. Other accounts posit two short vowels (ə a) and five long vowels (aː eː iː oː uː). There is a length contrast for /a/: /aː/ is back open, /a/ is central open.
\end{appendixdesc}
\subsubsection*{Syllable structure}
\begin{appendixdesc}
...
\item[Text:] “East Kewa” (lines 1-13, 32-58, \citealt{FranklinFranklin1978}: 483-487)

\item[Synthetic index:] 1.4 morphemes/word (399 morphemes, 278 words)
\end{appendixdesc}
\subsection*{[khc]}\addxcontentsline{tocappendix}{section}{[khc]}   {\textsc{Tukang Besi North}}  Austronesian, \textit{Malayo-Polynesian} (Indonesia)
...
\item[Notes:] There are also palatal phonemes loaned from Indonesian/Trade Malay. Author presents distributional/reduplication/syllabification evidence for analyzing prenasalized stops as unitary rather than sequences in reduplication processes.
\end{appendixdesc}
\subsubsection*{Syllable structure}
\begin{appendixdesc}
...
\item[Notes:] Donohue speculates that Tukang Besi has an incipient pitch accent system that’s developing through the regularization of phonetic properties of older non-contrastive stress system (1999: 34).
\end{appendixdesc}
\subsubsection*{Vowel reduction processes}
\begin{appendixdesc}
...
\end{appendixdesc}
\subsection*{[kjn]}\addxcontentsline{tocappendix}{section}{[kjn]}   {\textsc{Kunjen (Oykangand dialect)}}  Pama-Nyungan, \textit{Paman} (Australia)
...
\subsection*{[kpm]}\addxcontentsline{tocappendix}{section}{[kpm]}   {\textsc{Koho (Sre dialect)}}  Austroasiatic, \textit{Bahnaric} (Vietnam)
...
\item[Text:] “A grammar of Lao” \citep[488-497]{Enfield2007}
...
References consulted: \citet{Ingham2003}, Lakota Language \citet{Consortium2008}, \citet{Mirzayan2010}, \citet{RoodTaylor1996}
...
\item[Notes:] Duration is a significant correlate in certain segmental contexts. Intensity reported by Lakota Language \citet{Consortium2008} (’greater loudness’), but not instrumentally confirmed.
\end{appendixdesc}
\subsubsection*{Vowel reduction processes}
\begin{appendixdesc}
...
\item[Notes:] /ʔ/ is posited to avoid underlying syllabic nasals, otherwise its occurrence is completely predictable. I do not include it. /ʈ͡ʂ ʈ͡ʂ’ ʂ ʐ/ occur only in Western Dizin \citep{Beachy2005}. Allan gives 24 consonant phonemes, lists an inventory that is quite divergent from those posited by Beachy and Breeze.
\end{appendixdesc}
\subsubsection*{Syllable structure}
\begin{appendixdesc}
...
\item[Notes:] Author calls /ʔ/ a ‘semiconsonant’. /ɸ sʲ/ occur only in Spanish loans. /x/ occurs in diminutive speech style.
\end{appendixdesc}
\subsubsection*{Syllable structure}
\begin{appendixdesc}
...
\item[Notes:] It is possible Vietnam Kim Mun is in the process of losing onset clusters, as vowel epenthesis sometimes occurs in /kl/ sequences \citep[127]{Clark2008}.
\end{appendixdesc}
\subsubsection*{Suprasegmentals}
\begin{appendixdesc}
\item[Tone:] Yes
...
\subsection*{[mpc]}\addxcontentsline{tocappendix}{section}{[mpc]}   {\textsc{Mangarrayi}  }  Mangarrayi-Maran (Australia)
...
\item[Notes:] /ç/ ranges from alveolar to palatal fricative. The vowels transcribed as creaky voice differ in [RTR] value ([+RTR]), which manifests as both lower vowel quality and glottalic or ‘slight degree of raspiness’. This distinction is common in Mon-Khmer language and generally has phonation effects such as “breathiness, creakiness, or raspiness” \citep[14]{Alves2006}.
\end{appendixdesc}
\subsubsection*{Syllable structure}
\begin{appendixdesc}
...
\item[Text:] “The Old Days” and “Pacoh Fellows and Girls” (\citealt{Watson1980}: 86-7, 182-4)
...
\item[Notes:] Palatalized alveolars occur only in Saichia dialect. In Santimen, /ɾ r/ have merged. /h/ occurs in loans from Japanese in Saichia dialect.
\end{appendixdesc}
\subsubsection*{Syllable structure}
\begin{appendixdesc}
...
\subsection*{[roo]}\addxcontentsline{tocappendix}{section}{[roo]}   {\textsc{Rotokas}}  North Bougainville, \textit{Rotokas-Askopan} (Papua New Guinea)
...
\item[Notes:] Consonant phoneme representations are given as most characteristic allophonic realization. The contrast between voiceless, voiced, and nasal stops appears to have collapsed in Central Rotokas, producing this system, but these contrasts can still be found in Aita Rotokas \citep{Robinson2006}.
\end{appendixdesc}
\subsubsection*{Syllable structure}
\begin{appendixdesc}
...
\item[Notes:] /b t͡ɕ d͡z ɡ/ occur in Japanese loans, /pʰ tʰ t͡sʰ/ in Mandarin loans, /kʰ/ in Southern Min loans, and /h/ in Bunun loans.
\end{appendixdesc}
\subsubsection*{Syllable structure}
\begin{appendixdesc}
...
\item[Notes:] Initial clusters in Spanish loans may be prefixed with /s ʃ h/, resulting in triconsonantal onset.
\end{appendixdesc}
\subsubsection*{Suprasegmentals}
\begin{appendixdesc}
\item[Tone:] No
...
\item[Notes:] CCV syllables sometimes occur in Spanish loanwords in the speech of bilinguals, but these are usually split up by epenthesis \citep[76]{Olawsky2006}.
\end{appendixdesc}
\subsubsection*{Suprasegmentals}
\begin{appendixdesc}
\item[Tone:] Yes
