...
\section*{[alc] Qawasqar}\addxcontentsline{tocappendix}{section}{[alc]}   % {\textsc{Qawasqar}}
...
\section*{[als] Albanian (Tosk dialect)}\addxcontentsline{tocappendix}{section}{[als]} %%  {\textsc{Albanian} (Tosk dialect)}  
...
\section*{[aly] Alyawarra}\addxcontentsline{tocappendix}{section}{[aly]}  %% {\textsc{Alyawarra}} 
...
\section*{[amp] Alamblak}\addxcontentsline{tocappendix}{section}{[amp]}  % %{\textsc{Alamblak}}  
...
\end{appendixdesc}
\section*{[aot] Atong}\addxcontentsline{tocappendix}{section}{[aot]}  %% {\textsc{Atong}}  
...
\section*{[apn] Apinayé}\addxcontentsline{tocappendix}{section}{[apn]}   %%{\textsc{Apinayé}} 
...
\section*{[apu] Apurinã}\addxcontentsline{tocappendix}{section}{[apu]}   %%{\textsc{Apurinã}}  
...
\end{appendixdesc}
\section*{[ayz] Maybrat}\addxcontentsline{tocappendix}{section}{[ayz]}   %%{\textsc{Maybrat}}  
...
\section*{[bak] Bashkir}\addxcontentsline{tocappendix}{section}{[bak]}  %% {\textsc{Bashkir}}  
...
\section*{[bbo] Southern Bobo Madaré}\addxcontentsline{tocappendix}{section}{[bbo]}  %% {\textsc{Southern Bobo Madaré}} 
...
\section*{[bcj] Bardi}\addxcontentsline{tocappendix}{section}{[bcj]}  %% {\textsc{Bardi}  }  
...
\end{appendixdesc}
\section*{[bcq] Bench}\addxcontentsline{tocappendix}{section}{[bcq]}  %% {\textsc{Bench}  }  
...
\end{appendixdesc}
\section*{[bsk] Burushaski}\addxcontentsline{tocappendix}{section}{[bsk]} %%  {\textsc{Burushaski}}  
...
\section*{[cap] Chipaya}\addxcontentsline{tocappendix}{section}{[cap]} %%  {\textsc{Chipaya}}  
...
\end{appendixdesc}
\section*{[car] Carib}\addxcontentsline{tocappendix}{section}{[car]}   %%{\textsc{Carib}  }  
...
\end{appendixdesc}
\section*{[cav] Cavineña}\addxcontentsline{tocappendix}{section}{[cav]}  %% {\textsc{Cavineña}  }  
...
\end{appendixdesc}
\section*{[cho] Choctaw}\addxcontentsline{tocappendix}{section}{[cho]}  %% {\textsc{Choctaw}}  
...
\end{appendixdesc}
\section*{[coc] Cocopa}\addxcontentsline{tocappendix}{section}{[coc]}  %% {\textsc{Cocopa}}    
...
\section*{[cod] Cocama-Cocamilla}\addxcontentsline{tocappendix}{section}{[cod]}  %% {\textsc{Cocama-Cocamilla}}  
...
\end{appendixdesc}
\section*{[cub] Cubeo}\addxcontentsline{tocappendix}{section}{[cub]}  %% {\textsc{Cubeo}}    
...
\section*{[dow] Doyayo}\addxcontentsline{tocappendix}{section}{[dow]}  %% {\textsc{Doyayo}}    
...
\section*{[dru] Rukai (Budai dialect)}\addxcontentsline{tocappendix}{section}{[dru]}   %%{\textsc{Rukai} (Budai dialect)}  
...
\section*{[dry] Darai}\addxcontentsline{tocappendix}{section}{[dry]}  %% {\textsc{Darai}}   
...
\end{appendixdesc}
\section*{[dyo] Jola-Fonyi}\addxcontentsline{tocappendix}{section}{[dyo]}  %% {\textsc{Jola-Fonyi}}  
...
\section*{[eus] Basque (Central dialect)}\addxcontentsline{tocappendix}{section}{[eus]}   %%{\textsc{Basque} (Central dialect)}  
...
\item[Notes:] The Bizcaian dialects have pitch accent system. Saltarelli et al. describe five different accentual systems for dialects of \citet[282--283]{Basque1988}.
\end{appendixdesc}
\subsection*{Vowel reduction processes}
\begin{appendixdesc}
...
\end{appendixdesc}
\section*{[ewe] Ewe}\addxcontentsline{tocappendix}{section}{[ewe]}   %%{\textsc{Ewe}} 
...
\section*{[fvr] Fur}\addxcontentsline{tocappendix}{section}{[fvr]}  %% {\textsc{Fur}}  
Furan (Sudan)\medskip\\
...
\section*{[grj] Southern Grebo}\addxcontentsline{tocappendix}{section}{[grj]}  %% {\textsc{Southern Grebo}}  
...
\section*{[hts] Hadza}\addxcontentsline{tocappendix}{section}{[hts]}   %%{\textsc{Hadza}}  
...
\section*{[huu] Murui Huitoto}\addxcontentsline{tocappendix}{section}{[huu]}   %%{\textsc{Murui Huitoto}}  
...
\section*{[iii] Sichuan Yi}\addxcontentsline{tocappendix}{section}{[iii]} %%  {\textsc{Sichuan Yi}}  
...
\end{appendixdesc}
\section*{[itl] Itelmen}\addxcontentsline{tocappendix}{section}{[itl]}  %% {\textsc{Itelmen}}  
...
\section*{[kal] Kalaallisut}\addxcontentsline{tocappendix}{section}{[kal]}  %% {\textsc{Kalaallisut}}    
...
\section*{[kat] Georgian}\addxcontentsline{tocappendix}{section}{[kat]}  %% {\textsc{Georgian}}    
...
\end{appendixdesc}
\section*{[kbc] Kadiwéu}\addxcontentsline{tocappendix}{section}{[kbc]} %%  {\textsc{Kadiwéu}}  
...
\section*{[kbd] Kabardian}\addxcontentsline{tocappendix}{section}{[kbd]}  %% {\textsc{Kabardian}}  
...
\end{appendixdesc}
\section*{[kbh] Camsá}\addxcontentsline{tocappendix}{section}{[kbh]}  %% {\textsc{Camsá}}  
...
\section*{[kbk] Grass Koiari}\addxcontentsline{tocappendix}{section}{[kbk]}  %% {\textsc{Grass Koiari}}    
...
\end{appendixdesc}
\section*{[kca] Eastern Khanty}\addxcontentsline{tocappendix}{section}{[kca]}  %% {\textsc{Eastern Khanty}} 
...
\end{appendixdesc}
\section*{[ket] Ket}\addxcontentsline{tocappendix}{section}{[ket]}  %% {\textsc{Ket}}  
...
\end{appendixdesc}
\section*{[kew] East Kewa}\addxcontentsline{tocappendix}{section}{[kew]} %%  {\textsc{East Kewa}}  
...
\end{appendixdesc}
\section*{[khc] Tukang Besi North}\addxcontentsline{tocappendix}{section}{[khc]}   %%{\textsc{\ili{Tukang Besi North} }}  
Austronesian, \textit{Malayo-Polynesian} (Indonesia)\medskip\\\il{Tukang Besi North}
...
\end{appendixdesc}
\section*{[khr] Kharia}\addxcontentsline{tocappendix}{section}{[khr]}   %%{\textsc{Kharia}}   
...
\end{appendixdesc}
\section*{[kjn] Kunjen (Oykangand dialect)}\addxcontentsline{tocappendix}{section}{[kjn]}   %%{\textsc{\ili{Kunjen} (Oykangand dialect)}}  
Pama-Nyungan, \textit{Paman} (Australia)\medskip\\\il{Kunjen}
...
\section*{[kms] Kamasau}\addxcontentsline{tocappendix}{section}{[kms]}   %%{\textsc{Kamasau}}  
...
\end{appendixdesc}
\section*{[knc] Kanuri}\addxcontentsline{tocappendix}{section}{[knc]}   %%{\textsc{Kanuri}}    
...
\section*{[kpm] Koho (Sre dialect)}\addxcontentsline{tocappendix}{section}{[kpm]}   %%{\textsc{\ili{Koho} (Sre dialect)}}  
Austroasiatic, \textit{Bahnaric} (Vietnam)\medskip\\\il{Koho}
...
\end{appendixdesc}
\section*{[ktb] Kambaata}\addxcontentsline{tocappendix}{section}{[ktb]}   %%{\textsc{Kambaata}}  
...
\section*{[kyh] Karok}\addxcontentsline{tocappendix}{section}{[kyh]}  %% {\textsc{Karok}} 
...
\section*{[lao] Lao}\addxcontentsline{tocappendix}{section}{[lao]}  %% {\textsc{Lao}}  
...
\end{appendixdesc}
\section*{[lep] Lepcha}\addxcontentsline{tocappendix}{section}{[lep]}   %%{\textsc{Lepcha}}    
...
\end{appendixdesc}
\section*{[lez] Lezgian}\addxcontentsline{tocappendix}{section}{[lez]}  %% {\textsc{Lezgian}}  
...
\item[Synthetic index:] 1.7 morphemes/word (249 morphemes, 144 words)
\end{appendixdesc}
\section*{[lkt] Lakota}\addxcontentsline{tocappendix}{section}{[lkt]}  %% {\textsc{Lakota}}    
...
\end{appendixdesc}
\section*{[lpa] Lelepa}\addxcontentsline{tocappendix}{section}{[lpa]}  %% {\textsc{Lelepa}}  
...
\end{appendixdesc}
\section*{[lun] Lunda}\addxcontentsline{tocappendix}{section}{[lun]}  %% {\textsc{Lunda}  }  
...
\section*{[mcr] Menya}\addxcontentsline{tocappendix}{section}{[mcr]}  %% {\textsc{Menya}}    
...
\end{appendixdesc}
\section*{[mdx] Dizin (Central dialect)}\addxcontentsline{tocappendix}{section}{[mdx]}  %% {\textsc{Dizin} (Central dialect)}  
...
\end{appendixdesc}
\section*{[mhi] Ma’di}\addxcontentsline{tocappendix}{section}{[mhi]}   %%{\textsc{Ma’di}}  
...
\end{appendixdesc}
\section*{[mio] Pinotepa Mixtec}\addxcontentsline{tocappendix}{section}{[mio]}  %% {\textsc{Pinotepa Mixtec}}  
...
\section*{[mjg] Tu}\addxcontentsline{tocappendix}{section}{[mjg]}   %%{\textsc{Tu}}    
...
\end{appendixdesc}
\section*{[mji] Kim Mun (Vietnam dialect)}\addxcontentsline{tocappendix}{section}{[mji]}  %% {\textsc{Kim Mun} (Vietnam dialect)}  
...
\section*{[moh] Mohawk}\addxcontentsline{tocappendix}{section}{[moh]}   %%{\textsc{Mohawk}}  
...
\section*{[mpc] Mangarrayi}\addxcontentsline{tocappendix}{section}{[mpc]} %%  {\textsc{Mangarrayi}  }  
...
\section*{[mpi] Mpade (Makari dialect)}\addxcontentsline{tocappendix}{section}{[mpi]}   %%{\textsc{Mpade} (Makari dialect)}  
...
\section*{[mri] Maori}\addxcontentsline{tocappendix}{section}{[mri]}   %%{\textsc{Maori}}  
...
\section*{[nir] Nimboran}\addxcontentsline{tocappendix}{section}{[nir]}   %%{\textsc{Nimboran}}  
...
\end{appendixdesc}
\section*{[niv] Nivkh (West Sakhalin dialect)}\addxcontentsline{tocappendix}{section}{[niv]}  %% {\textsc{Nivkh} (West Sakhalin dialect)}  
...
\end{appendixdesc}
\section*{[nsm] Sumi Naga}\addxcontentsline{tocappendix}{section}{[nsm]}   %%{\textsc{Sumi Naga}}  
...
\section*{[nuk] Nuu-chah-nulth}\addxcontentsline{tocappendix}{section}{[nuk]}   %%{\textsc{Nuu-chah-nulth}}  
...
\section*{[ood] Tohono O’odham}\addxcontentsline{tocappendix}{section}{[ood]}   %%{\textsc{Tohono O’odham}}  
...
\end{appendixdesc}
\section*{[opm] Oksapmin}\addxcontentsline{tocappendix}{section}{[opm]}  %% {\textsc{Oksapmin}}  
...
\section*{[pac] Pacoh}\addxcontentsline{tocappendix}{section}{[pac]}   %%{\textsc{Pacoh}}  
...
\end{appendixdesc}
\section*{[pay] Pech}\addxcontentsline{tocappendix}{section}{[pay]}  %% {\textsc{Pech}}  
...
\end{appendixdesc}
\section*{[pib] Yine}\addxcontentsline{tocappendix}{section}{[pib]}   %%{\textsc{Yine}}  
...
\end{appendixdesc}
\section*{[pol] Polish}\addxcontentsline{tocappendix}{section}{[pol]}   %%{\textsc{Polish}}  
...
\section*{[pqm] Passamaquoddy-Maliseet}\addxcontentsline{tocappendix}{section}{[pqm]}  %% {\textsc{Passamaquoddy-Maliseet}}  
...
\end{appendixdesc}
\section*{[pwn] Paiwan (Saichia dialect)}\addxcontentsline{tocappendix}{section}{[pwn]}  %% {\textsc{Paiwan}} (Saichia dialect)  
Austronesian (Taiwan)\medskip\\
...
\section*{[qvi] Imbabura Highland Quichua}\addxcontentsline{tocappendix}{section}{[qvi]}  %% {\textsc{Imbabura Highland Quichua}}    
...
\section*{[roo] Rotokas}\addxcontentsline{tocappendix}{section}{[roo]}   %%{\textsc{Rotokas}}  
...
\section*{[scs] North Slavey (Hare dialect)}\addxcontentsline{tocappendix}{section}{[scs]}   %%{\textsc{North Slavey}} (Hare dialect)  
...
\section*{[sea] Semai}\addxcontentsline{tocappendix}{section}{[sea]}   %%{\textsc{Semai}  } 
...
\section*{[shi] Tashlhiyt}\addxcontentsline{tocappendix}{section}{[shi]}   %%{\textsc{Tashlhiyt}}  
...
\section*{[spl] Selepet}\addxcontentsline{tocappendix}{section}{[spl]}  %% {\textsc{Selepet}}  
...
\section*{[svs] Savosavo}\addxcontentsline{tocappendix}{section}{[svs]} %%  {\textsc{Savosavo}}  
...
\section*{[sxr] Saaroa}\addxcontentsline{tocappendix}{section}{[sxr]}   %%{\textsc{Saaroa}  }  
...
\section*{[tbi] Gaam}\addxcontentsline{tocappendix}{section}{[tbi]}   %%{\textsc{Gaam}}  
...
\section*{[teh] Tehuelche}\addxcontentsline{tocappendix}{section}{[teh]}  %% {\textsc{Tehuelche}}  
...
\section*{[tel] Telugu}\addxcontentsline{tocappendix}{section}{[tel]}  %% {\textsc{Telugu}}    
...
\section*{[thp] Thompson}\addxcontentsline{tocappendix}{section}{[thp]}  %% {\textsc{Thompson}}  
...
\section*{[tow] Towa}\addxcontentsline{tocappendix}{section}{[tow]}  %% {\textsc{Towa}  }  
...
\section*{[tzh] Tzeltal (Aguacatenango dialect)}\addxcontentsline{tocappendix}{section}{[tzh]}  %% {\textsc{Tzeltal}} (Aguacatenango dialect)  
...
\section*{[ung] Ngarinyin}\addxcontentsline{tocappendix}{section}{[ung]}  %% {\textsc{Ngarinyin}}  
...
\section*{[ura] Urarina}\addxcontentsline{tocappendix}{section}{[ura]}  %% {\textsc{Urarina}}  
...
\section*{[ute] Ute}\addxcontentsline{tocappendix}{section}{[ute]}   %%{\textsc{Ute}  }  
...
\section*{[wba] Warao}\addxcontentsline{tocappendix}{section}{[wba]} %%{\textsc{Warao}}  
...
\section*{[wmd] Mamaindê}\addxcontentsline{tocappendix}{section}{[wmd]} %%{\textsc{Mamaindê}}  
...
\section*{[wut] Wutung}\addxcontentsline{tocappendix}{section}{[wut]}   %%{\textsc{Wutung}}  
...
\section*{[yak] Yakima Sahaptin}\addxcontentsline{tocappendix}{section}{[yak]}  %% {\textsc{Yakima Sahaptin}}  
...
\section*{[yor] Yoruba}\addxcontentsline{tocappendix}{section}{[yor]}  %% {\textsc{Yoruba}}  
...
\section*{[yue] Cantonese}\addxcontentsline{tocappendix}{section}{[yue]}   %%{\textsc{Cantonese}}  
