...
\lsptoprule {ISO} & {Language}  & {MA} & {Tlf} & {Subfamily} & \multicolumn{1}{c}{Pop} & {Date} & {Vit}\\\midrule
 ...
 roo & {{Rotokas}} &  ANG & {North Bougainville} & {\textit{\ili{Rotokas}-Askopan}} &  4,320 & 1981 & D\\
 ...
 dru & {{\ili{Rukai} (Budai dialect)}} &  SEA & {Austronesian} &  &  10,500 & 2002 & D\\
 mri & {{Maori}} &  SEA  & {Austronesian} & {\textit{Malayo-Polynesian}} &  158,640 & 2013 & T\\
 khc & {{\ili{Tukang Besi} North}} &  SEA  & {Austronesian} & {\textit{Malayo-Polynesian}} &  120,000 & 1995 & V\\
...
\lsptoprule {ISO} & {Language} & {MA} & {Tlf} & {Subfamily} & \multicolumn{1}{c}{Pop} & {Date} & {Vit}\\\midrule
 ...
 ayz & {{Maybrat}} &  ANG & {\ili{Maybrat}-Karon} &  &  20,000 & 1987 & D\\
 ...
 scs & {{\ili{North Slavey} (Hare dialect)}} &  NA & {Athabaskan-Eyak-Tlingit} & {\textit{Athabaskan-Eyak}} &  710 & 2007 & T\\
 ...
 mji & {{\ili{Kim Mun}\footnote{(Vietnam dialect)}}} &  SEA  & {Hmong-Mien} & {\textit{Mienic}} &  374,500 & 2000 & V\\
...
\begin{tabularx}{\textwidth}{lQlQQrlc}
\lsptoprule {ISO} & {Language} & {MA} & {Tlf} & {Subfamily} & \multicolumn{1}{c}{Pop} & {Date} & {Vit}\\\midrule
 mpi & {{\ili{Mpade} (Makari dialect)}} &  A & {Afro-Asiatic} & {\textit{Chadic}} &  16,000 & 2004 & T\\
 ...
 mdx & {{\ili{Dizin} (Central dialect)}} &  A & {Dizoid} &  &  33,900 & 2010 & I\\
 tbi & {{Gaam}} &  A & {Eastern Jebel} &  &  67,200 & 2000 & V\\
 mpc & {{Mangarrayi}} &  ANG & {\ili{Mangarrayi}-Maran} &  &  12 & 2006 & †\\
 ...
 niv & {{\ili{Nivkh} (West Sakhalin dialect)}} &  EA & {(isolate)} &  &  15\footnote{Population figure from \citet{BotmaShiraishi2014}.} & 2014 & †\\
...
\lsptoprule {ISO} & {Language} & {MA} & {Tlf} & {Subfamily} & \multicolumn{1}{c}{Pop} & {Date} & {Vit}\\\midrule
 ...
 kbd & {{Kabardian}} &  EA & {\ili{Abkhaz}-Adyge} & {\textit{Circassian}} &  1,628,500 & 2010 & D\\
 itl & {{Itelmen}} &  EA & {Chukotko-Kamchatkan} &  &  80 & 2010 & †\\
 als & {{\ili{Albanian}\footnote{(Tosk dialect)}}} &  EA & {Indo-Europ.} & {\textit{Albanian}} &  1,841,400 & 2012 & I\\
 pol & {{Polish}} &  EA & {Indo-Europ.} & {\textit{Balto-Slavic}} &  40,248,740 & 2013 & I\\
 kat & {{Georgian}} &  EA & {Kartvelian} & {\textit{\ili{Georgian}-Zan}} &  4,347,320 & 1993 & I\\
