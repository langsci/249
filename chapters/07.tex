...
\lsptoprule
 ...
 Conditioning environment & Palato-alveolar & Uvular & Affricate & Total for group\\
 & \textit{N} = 32 & \textit{N} = 9 & \textit{N} = 36 & \textit{N} = 57\\\midrule
...
\lsptoprule
 & \multicolumn{3}{c}{Allophonic processes yielding:} \\\cmidrule(lr){2-4}
Conditioning environment & Palatalization & Labialization & Velarization & Total for group\\
