...
\pgfplotstableread{data/fig35.csv}{\table}
    ...
    \pgfmathtruncatemacro\numberofcols{\pgfplotsretval-1}
            \begin{axis}[easterdaystacked,
                                xticklabels={{Moderately Complex}, Complex, {Highly Complex}},
                        ]
            \foreach \i in {1,...,\numberofcols} {
                \addplot+[
                    /pgf/number format/read comma as period, fill
...
\pgfplotstableread{data/fig36.csv}{\table}
    ...
    \pgfmathtruncatemacro\numberofcols{\pgfplotsretval-1}
            \begin{axis}[easterdaystacked,
                                xticklabels={Complex, {Highly Complex}},
                        ]
            \foreach \i in {1,...,\numberofcols} {
                \addplot+[
                    /pgf/number format/read comma as period, fill
...
\begin{tabular}{lcccc}
\lsptoprule
{Language}& {Maximal \#-init} & {Morphol.} & Maximal \#-fin  & Morphol. \\
...
{Passamaquoddy-} & \textbf{Onset:} psk, ksp, pskʷ & — & —\\
                        Maliseet &  \textbf{Coda:} pskʷ, kskʷ  \\
...
\begin{tabularx}{\textwidth}{p{1.25cm}p{3cm}Q}
\lsptoprule
