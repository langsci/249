...
In Tehuelche, the reference indicates that sequences of up to six consonants may occur word-finally, but the only illustrative example of a pattern this size given is \REF{ex:3.13}.
...
(\citealt{HargusBeavert2002}: 270--271)
\z
\z
...
{Camsá} & 1 & “Consonant clusters are very common in Camsá. […] \textbf{{Clusters of three consonants are not as common}} in the language as clusters of two.” \citep[81--84]{Howard1967}\\
