...
\lsptoprule
 ...
 \textit{N} languages with: & Simple & Moderately Complex & Complex & Highly Complex\\
...
\lsptoprule
 & \multicolumn{4}{c}{Syllable structure complexity}\\\cmidrule(lr){2-5}
 \textit{N} distinct vowel reduction processes: & Simple & Moderately Complex & Complex & Highly Complex\\
                            & \textit{N} = 24 & \textit{N} = 26 & \textit{N} = 25 & \textit{N} = 25\\\midrule
 Median & 1 & 1.5 & 2 & 2\\
...
\lsptoprule
 & \multicolumn{4}{c}{Syllable structure complexity} & \textit{Totals}\\\cmidrule(lr){2-5}
 {Affected vowels} & Simple & Moderately Complex & Complex & Highly Complex\\
...
\lsptoprule
 & \multicolumn{4}{c}{Syllable structure complexity}\\\cmidrule(lr){2-5}
  V reduction processes affecting /ə/ & Simple & Moderately Complex & Complex & Highly Complex\\
...
\lsptoprule
 & \multicolumn{4}{c}{Syllable Structure Complexity} & \textit{Totals}\\\cmidrule(lr){2-5}
 Conditioning environments & Simple & Moderately Complex & Complex & Highly Complex\\
 \textit{N} processes & 24 &  49 &  48  &  57  & \\\midrule
 \multicolumn{6}{c}{Single environment} \\\midrule
 ...
 \multicolumn{6}{c}{Combination of environments} \\\midrule
...
\lsptoprule
 & \multicolumn{4}{c}{Syllable structure complexity}\\\cmidrule(lr){2-5}
  & Simple & Moderately Complex & Complex & Highly Complex\\\midrule
...
\begin{tabularx}{\textwidth}{Qccccr}
\lsptoprule
 & \multicolumn{4}{c}{Syllable structure complexity} & \textit{Totals}\\
 Outcome of vowel reduction processes & Simple & Moderately Complex & Complex & Highly Complex\\
 \textit{N} processes & 24  &  49  &  48  &  57  & \\\midrule
 \multicolumn{6}{c}{Single outcome from process}\\\midrule
 ...
 \multicolumn{6}{c}{Several outcomes from process}\\\midrule
...
\lsptoprule
 & \multicolumn{4}{c}{Syllable structure complexity}\\\cmidrule(lr){2-5}
Structure resulting from vowel deletion & Simple & Moderately Complex & Complex & Highly Complex\\
