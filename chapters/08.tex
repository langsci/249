...
\ea\label{ex:8.3}
  \etriple{Lezgian}{Nakh-Daghestanian}{Azerbaijan, Russia}\medskip\\
\begin{tabular}{@{}lll@{}}
...
e[as={domain-conditioned V devoicing},text width=3cm] ->[dashed] f[as={\itshape destabilization of stress patterns?},draw=none,text width=3.1cm] ->[dashed] {g[as={stress-conditioned V reduction, deletion},text width=3cm],h[as={syllabic Cs},yshift=3\baselineskip]} -> i[as={increased V reduction},text width=3.2cm] <- j[xshift=-4.475cm,yshift=-5\baselineskip,draw=none,as={\itshape stronger effects when morpheme/word ratio high, grammatical morphemes involved?},text width=3.2cm];
};
